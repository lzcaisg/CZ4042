# PartA-Q1: LzCai Oct/2018 U1622184H
...
init_variables()
    ...
    train_graphName = "PartA-Train"+str(EPOCHS)+'-'+str(BATCH_SIZE)+file_name_label+".png"
    test_graphName = "PartA-Test"+str(EPOCHS)+'-'+str(BATCH_SIZE)+file_name_label+".png"
    ...
    fileNameTail = str(EPOCHS)+'-'+str(BATCH_SIZE)+file_name_label+".out"
